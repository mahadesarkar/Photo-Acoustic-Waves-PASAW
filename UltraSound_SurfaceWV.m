...
sensors = round(0.2*Ny):round(7e-3/dx):round(0.3*Ny)+8*round(10e-3/dx);
...
input_args = {'PlotScale',[-1, 1]*source_strength,'PlotPML', true,'PMLSize', PML_size, 'DisplayMask', source.s_mask + sensor.mask,'DataCast', 'gpuArray-single', 'PMLAlpha',4};
%{
